...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { complete: @habit.complete, name: @habit.name } }, as: :json
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { complete: @habit.complete, name: @habit.name } }, as: :json
    assert_response 200
  end
